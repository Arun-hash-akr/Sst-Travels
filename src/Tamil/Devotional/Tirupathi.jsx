...
const images = [
    ...
    { src: thiurvannamalai, name: "Thiurvannamalai" },
    { src: alamelu, name: "Alamelu Mangai" },
    { src: kalashthi, name: "Kalashthi" },
    { src: Tiruttani, name: "Tiruttani" },
    { src: goldentemple, name: "Thirumalaikodi" },
];
...
const Thirunallar = () => {
    ...
    return (
        <div id="tnr">
            ...
            {/* PLACES */}
            <div className="heads">
                <h3>Places to Visit in Tirupathi</h3>
                <ul>
                    {images.map((item, i) => (
