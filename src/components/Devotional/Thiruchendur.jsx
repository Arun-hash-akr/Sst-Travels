...
const images = [
    { src: thiruchendur, name: "Thiruchendur" },
    { src: muttharamman, name: "Kulasekarapattinam" },
    { src: vantirupati, name: "Vantirupati" },
    { src: Thenthiruperai, name: "Thenthiruperai" },
    { src: Srivaikuntanathan, name: "Tiruttani" },
];
...
const Thirunallar = () => {
    ...
    return (
        <div id="tnr">
            ...
            {/* PLACES */}
            <div className="heads">
                <h3>Places to Visit in Thiruchendur</h3>
                <ul>
                    {images.map((item, i) => (
