        ...
        <div className="cards">
          ...
          <div className="crd1">
            <div className="crd">
              ...
              <Link to="/ta/thirunallaru">மேலும்.</Link>
            </div>
            ...
            <div className="crd">
              ...
              <Link to="/ta/tirupathi">மேலும்.</Link>
            </div>
            ...
            <div className="crd">
              ...
              <Link to="/ta/thiruchendur">மேலும்.</Link>
            </div>
          ...
          <div className="crd2">
            ...
            <div className="crd" id='rmr'>
              ...
              <Link to="/ta/rameshwaram">மேலும்.</Link>
