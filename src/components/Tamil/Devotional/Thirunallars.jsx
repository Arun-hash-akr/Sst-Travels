...
const images = [
  { src: ThirunallarImg, name: "திருநள்ளாறு" },
  { src: Thirukadaiyur, name: "திருக்கடையூர்" },
  { src: Karaikal, name: "காரைக்கால்" },
  { src: Vellankani, name: "வேளாங்கண்ணி" },
  { src: Aalangudi, name: "ஆலங்குடி" },
];
...
const Thirunallar = () => {
  ...
  return (
    <div id="tnr">
      ...
      {/* PLACES */}
      <div className="heads">
        <h3>திருநள்ளாரில் பார்க்க வேண்டிய இடங்கள்</h3>
        <ul>
          {images.map((item, i) => (
