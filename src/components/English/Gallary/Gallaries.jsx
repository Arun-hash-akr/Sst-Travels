...
const Gallaries = () => {
  ...
  return (
    <section className="en-Gallary">
      <h3>Gallery</h3>

      <div className="en-carousel" ref={carouselRef}>
        <div
        ...
        >
          {images.map((image, index) => (
            <div className="en-carousel-slide" key={index}>
              <img src={image} alt={`Gallery ${index + 1}`} />
            </div>
          ))}
        </div>

        <button className="en-prev" onClick={prevSlide}>
          ❮
        </button>

        <button className="en-next" onClick={nextSlide}>
          ❯
        </button>
      </div>
    </section>
